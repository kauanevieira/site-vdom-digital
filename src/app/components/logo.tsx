  ...
  return (
    <Link href="/" className="flex items-center gap-2">
      <div className="relative w-10 h-10 flex justify-center items-center rotate-45">
        ...
        <IconCircleFilled size={10} className="text-zinc-200 absolute"/>
      </div>
      <span className="font-black text-xl bg-clip-text text-transparent bg-gradient-to-b from-zinc-200 to-zinc-400">
        Minha APP
      </span>
    </Link>
  );
